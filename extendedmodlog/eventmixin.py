...
class EventMixin:
    ...
    async def on_raw_bulk_message_delete(self, payload: discord.RawBulkMessageDeleteEvent):
        ...
        if embed_links:
            ...
            embed.set_author(name=_("Bulk message delete"), icon_url=(guild.icon.url if guild.icon else None))
            embed.add_field(name=_("Channel"), value=message_channel.mention)
    ...
    async def on_guild_update(self, before: discord.Guild, after: discord.Guild) -> None:
        ...
        embed.set_author(name=_("Updated Guild"), icon_url=str((guild.icon.url if guild.icon else None)))
